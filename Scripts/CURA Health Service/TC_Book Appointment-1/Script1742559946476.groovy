...
WebUI.verifyElementText(findTestObject('Object Repository/Page_CURA Healthcare Service/a_btn-make-appointment'), 'Make Appointment')
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment'), 'Make an appointment')
