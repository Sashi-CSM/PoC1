...
def petPayload = '{"name": "doggie__unique__", "photoUrls": ["https://example.com/photo"]}'
...
def userPayload = '{"username": "user__unique__", "firstName": "John", "lastName": "Doe", "email": "john.doe@example.com", "password": "password123", "phone": "1234567890", "userStatus": 1}'
