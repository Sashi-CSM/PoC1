...
def petPayload = new HttpTextBodyContent(replaceSuffixWithUUID('{"category": {"id": 1, "name": "category__unique__"}, "name": "pet__unique__", "photoUrls": ["photo_url"]}'))
...
def petPayloadMissingPhotoUrls = new HttpTextBodyContent(replaceSuffixWithUUID('{"category": {"id": 1, "name": "category__unique__"}, "name": "pet__unique__"}'))
def createPetMissingPhotoUrlsRequest = findTestObject('Object Repository/Swagger Petstore/addPet')
createPetMissingPhotoUrlsRequest.setBodyContent(petPayloadMissingPhotoUrls)
addHeaderConfiguration(createPetMissingPhotoUrlsRequest)
def createPetMissingPhotoUrlsResponse = WSBuiltInKeywords.sendRequest(createPetMissingPhotoUrlsRequest)
WSBuiltInKeywords.verifyResponseStatusCode(createPetMissingPhotoUrlsResponse, 405)
