...
def petPayload = new HttpTextBodyContent(replaceSuffixWithUUID('{"id": 1, "category": {"id": 1, "name": "category__unique__"}, "photoUrls": [], "tags": [], "status": "available"}'))
...
WSBuiltInKeywords.verifyResponseStatusCode(createPetResponse, 405)
