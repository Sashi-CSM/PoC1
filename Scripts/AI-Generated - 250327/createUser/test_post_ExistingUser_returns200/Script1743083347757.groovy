...
def petPayload = '{"name": "TestPet__unique__", "photoUrls": ["url1", "url2"], "category": {"id": 1, "name": "TestCategory__unique__"}}'
...
def userPayload = '{"username": "ExistingUser", "userStatus": 1}'
...
def duplicateUserResponse = WSBuiltInKeywords.sendRequest(userRequest)
WSBuiltInKeywords.verifyResponseStatusCode(duplicateUserResponse, 200)
