...
def petPayload = '{"name": "doggie__unique__", "photoUrls": ["photoUrl1__unique__", "photoUrl2__unique__"], "status": "available"}'
...
println("Step 3 - Response Status Code: ${deletePetResponse.getStatusCode()}")
