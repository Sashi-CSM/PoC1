...
def petPayload = '{"name": "Third Pet", "photoUrls": ["url5", "url6"], "category": {"id": 3, "name": "Third Category"}, "tags": [], "status": "available"}'
...
def getPetByTagsRequest = findTestObject('Object Repository/Swagger Petstore/findPetsByTags')
def getPetByTagsResponse = WSBuiltInKeywords.sendRequest(getPetByTagsRequest)
WSBuiltInKeywords.verifyResponseStatusCode(getPetByTagsResponse, 400)
