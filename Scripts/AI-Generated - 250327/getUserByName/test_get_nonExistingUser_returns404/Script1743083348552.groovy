...
def get_user_request = findTestObject('Object Repository/Swagger Petstore/getUserByName', ['username': 'test_user__unique__'])
addHeaderConfiguration(get_user_request)
def get_user_response = WSBuiltInKeywords.sendRequest(get_user_request)
WSBuiltInKeywords.verifyResponseStatusCode(get_user_response, 404)
WSBuiltInKeywords.verifyResponseStatusCode(get_user_response, 404)
