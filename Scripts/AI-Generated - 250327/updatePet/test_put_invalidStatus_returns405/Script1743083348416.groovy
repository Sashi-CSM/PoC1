...
def petPayload = '{"id": 100, "name": "Another Pet", "photoUrls": ["url1", "url2"], "status": "invalid_status", "category": {"id": 2, "name": "Another Category"}}'
...
def putRequest = findTestObject('Object Repository/Swagger Petstore/updatePet')
def putPayloadContent = new HttpTextBodyContent(replaceSuffixWithUUID(petPayload))
...
println(putResponse.getResponseText())
