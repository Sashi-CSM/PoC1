...
def update_user_payload = new HttpTextBodyContent(replaceSuffixWithUUID('{"id": 1, "username": "test_user__unique__", "firstName": "Jane", "lastName": "Doe", "email": "jane.doe@example.com", "password": "password123", "phone": "1234567890", "userStatus": "active"}'))
...
println("Test passed: Response status code is 400")
