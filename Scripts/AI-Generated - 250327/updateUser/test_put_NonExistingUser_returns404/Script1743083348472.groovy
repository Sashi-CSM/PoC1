...
def non_existing_username = "non_existing_user__unique__"
def update_user_payload = new HttpTextBodyContent(replaceSuffixWithUUID('{"id": 1, "username": "' + non_existing_username + '", "firstName": "Jane", "lastName": "Smith", "email": "jane.smith@example.com", "password": "newpassword456", "phone": "9876543210", "userStatus": 2}'))
def update_user_request = findTestObject('Object Repository/Swagger Petstore/updateUser', ['username': non_existing_username])
...
WSBuiltInKeywords.verifyResponseStatusCode(update_user_response, 404)
